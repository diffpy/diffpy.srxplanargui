...
# -*- coding: utf-8 -*-
#
# diffpy.srxplanargui documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.srxplanargui")
except Exception:
...
modindex_common_prefix = ["diffpy.srxplanargui"]
...
html_context = {
    "display_github": True,
    "github_user": "diffpy",
    "github_repo": "diffpy.srxplanargui",
    "github_version": "main",
...
basename = "diffpy.srxplanargui".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.srxplanargui.tex",
        "diffpy.srxplanargui Documentation",
        ab_authors,
        "manual",
    ),
]
